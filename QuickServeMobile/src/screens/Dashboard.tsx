...
import { Clock, Package, History } from 'lucide-react-native';
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>
          Bienvenue sur{' '}
          <Text style={styles.highlight}>QuickServe</Text>
        </Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity style={styles.emptyStateButton}>
            <Text style={styles.emptyStateButtonText}>Découvrir les services</Text>
          </TouchableOpacity>
        </View>
      </View>
