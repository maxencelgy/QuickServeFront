...
import { Award, Clock, Star, Users } from "lucide-react-native";
				...
				<View style={styles.valuesGrid}>
					<View style={styles.valueCard}>
						...
						<Text style={styles.valueDescription}>
							Nous nous engageons à fournir des services d'excellence à chaque
							intervention.
						</Text>
					</View>
					<View style={styles.valueCard}>
						...
						<Text style={styles.valueDescription}>
							Une intervention rapide et efficace pour répondre à vos besoins
							urgents.
						</Text>
					</View>
					<View style={styles.valueCard}>
						...
						<Text style={styles.valueDescription}>
							Des professionnels qualifiés et formés pour un service
							irréprochable.
						</Text>
					</View>
					<View style={styles.valueCard}>
						...
						<Text style={styles.valueDescription}>
							Une relation de confiance durable avec nos clients et nos
							partenaires.
						</Text>
					</View>
				</View>
