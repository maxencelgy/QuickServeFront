...
import { Clock, Package, Star } from "lucide-react-native";
...
type ServicesScreenNavigationProp =
...
const services = [
	{
		...
		image:
			"https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80",
	...
	},
	{
		id: "demenagement",
		title: "Déménagement",
		description: "ServiceCategory complet de déménagement professionnel",
		image:
			"https://images.unsplash.com/photo-1580709839515-54b8991e2813?q=80&w=2029&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
		price: "Sur devis",
		duration: "1-2 jours",
		rating: 4.9,
	},
	...
	},
	{
		...
		image:
			"https://images.unsplash.com/photo-1621905251189-08b45d6a269e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80",
