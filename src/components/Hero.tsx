			...
			<div className="container mx-auto px-4 py-16 sm:py-24 relative z-10">
				<div className="text-center max-w-3xl mx-auto fade-in">
					...
					<p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
						Transport, déménagement, nettoyage, dépannage & accompagnement –
						tous vos services, rapidement et en toute sécurité.
					</p>
					...
					<div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-xl shadow-lg max-w-xs transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
						<div className="flex items-center gap-3">
							...
							<p className="text-sm font-medium">
								Plus de <span className="font-bold">10 000</span> clients
								satisfaits
							</p>
						</div>
					</div>
