	...
	const values = [
		{
			...
			title: "Qualité",
			description:
				"Des prestations de service irréprochables à chaque intervention",
			color: "bg-pink-50",
		},
		{
			icon: Target,
		...
		},
		{
			...
			title: "Confiance",
			description:
				"La sécurité et la fiabilité au cœur de nos serviceCategories",
			color: "bg-emerald-50",
		},
	];
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div className="order-2 lg:order-1">
							...
							<p className="text-muted-foreground mb-6">
								QuickServe a été créé avec une ambition claire : rendre les
								services du quotidien accessibles à tous, rapidement et
								efficacement. Notre plateforme connecte les utilisateurs avec
								des professionnels qualifiés pour tous types de services.
							</p>
							<p className="text-muted-foreground mb-8">
								Depuis notre création en 2018, nous avons servi des milliers de
								clients satisfaits et continuons d'étendre notre réseau de
								professionnels certifiés dans toute la France.
							</p>
							<Button
								size="lg"
								asChild
				...
				<div className="container mx-auto px-4">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground max-w-2xl mx-auto">
							Les principes qui guident chacune de nos actions et services que
							nous offrons.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						{values.map((value, index) => (
							<Card
								key={index}
								className="border-0 hover:shadow-xl transition-all duration-300 group bg-white"
							>
								<CardContent className="p-6">
									<div
										className={`mb-6 w-16 h-16 rounded-full ${value.color} flex items-center justify-center group-hover:bg-primary transition-colors duration-300`}
									>
					...
					<div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
						{stats.map((stat, index) => (
							<Card
								key={index}
								className="border-0 bg-gradient-to-br from-primary/5 to-transparent hover:shadow-xl transition-all duration-300"
							>
			...
			<div className="py-20 bg-gradient-to-t from-secondary/10 to-transparent">
				<div className="container mx-auto px-4">
					<div className="text-center mb-16">
						...
						<p className="text-muted-foreground max-w-2xl mx-auto">
							Nous aspirons à créer un réseau de services innovants qui
							transformera le quotidien de nos clients.
						</p>
					</div>
							...
							<div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-10">
								...
								<div>
									<h3 className="text-2xl font-bold mb-4">
										Rejoignez l'aventure QuickServe
									</h3>
									<p className="text-muted-foreground mb-6">
										Vous êtes un professionnel et souhaitez rejoindre notre
										réseau ? Ou peut-être avez-vous besoin de nos services ?
										Dans tous les cas, nous sommes là pour vous.
									</p>
