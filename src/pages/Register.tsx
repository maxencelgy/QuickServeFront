...
import { Check, Lock, Mail, User, Phone } from "lucide-react";
...
const Register = () => {
  ...
  useEffect(() => {
    ...
    if (formData.phone.length > 14) {
      setFormData({ ...formData, phone: formData.phone.substring(0, formData.phone.length - 1) })
    }
  }, [formData.phone]);
  ...
  const handlePhoneKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    if (key === "Backspace" && lastCharacter === " ") {
      const trimmedPhone = formData.phone.substring(0, formData.phone.length - 1);
        ...
        <div className="w-full max-w-md space-y-8 p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div className="space-y-4">
              ...
              <div className="mt-5">
                <label className="mt-5" htmlFor="role">Votre rôle :</label>
                <Select name="role" value={formData.role} onValueChange={e => {
                  console.log('e', e)
