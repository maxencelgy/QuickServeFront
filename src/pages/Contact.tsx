...
import { Clock, Mail, MapPin, Phone, UserCheck, Users } from "lucide-react";
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
					<div className="lg:col-span-2">
						...
						<form className="space-y-6 bg-white p-8 rounded-xl shadow-md">
							...
							<Button
								type="submit"
								className="w-full md:w-auto px-8 hover:scale-105 transition-transform duration-300"
							>
								Envoyer
							</Button>
						</form>
				...
				<div className="mt-20">
					<div className="text-center mb-12">
						...
						<p className="text-muted-foreground max-w-2xl mx-auto mt-2">
							Des experts à votre service pour vous accompagner dans tous vos
							projets
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								image:
									"https://images.unsplash.com/photo-1600486913747-55e5470d6f40?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&h=200&q=80",
							},
							{
								name: "Sophie Legrand",
								role: "ServiceCategory client",
								image:
							...
							<Card
								key={index}
								className="overflow-hidden group hover:shadow-xl transition-all duration-300 border-0 shadow-md"
							>
